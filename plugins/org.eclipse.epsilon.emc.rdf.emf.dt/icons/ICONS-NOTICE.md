The Semantic Web logos in this folder are Copyright (C) 2007 W3C.

The original versions are available from:

  https://www.w3.org/2007/10/sw-logos.html

The full text of the W3C Document License as of December 5th 2025 is included below.
...
* The pre-existing copyright notice of the original author, or if it doesn't exist, a notice (hypertext is preferred, but a textual representation is permitted) of the form: "Copyright © [$date-of-document] [World Wide Web Consortium](https://www.w3.org/). https://www.w3.org/copyright/document-license-2023/"
