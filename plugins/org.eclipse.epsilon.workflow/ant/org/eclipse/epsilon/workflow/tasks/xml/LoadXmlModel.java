...
public class LoadXmlModel extends AbstractLoadModelTask {
	...
	/**
	 * Controls whether XML entity references are expanded during parsing.
	 * Set to {@code false} to preserve character entity references (e.g.
	 * {@code &#xD;}) as-is in the DOM, preventing data corruption from
	 * XML end-of-line normalization.
	 * 
	 * @param expand {@code true} to expand (default), {@code false} to preserve
	 */
