...
public class PlainXmlModel extends CachedModel<Element> implements IOperationContributorProvider {
	...
	/**
	 * Controls whether the XML parser expands entity references when loading.
	 * When set to {@code false}, character entity references (e.g. {@code &#xD;})
	 * are preserved as-is in the DOM rather than being resolved to their character
	 * values. This prevents silent data corruption caused by XML end-of-line
	 * normalization (XML spec §2.11) and provides defense-in-depth against
	 * external entity (XXE) expansion.
	 *
	 * @param expandEntityReferences {@code true} to expand (default), {@code false} to preserve
	 */
	...
	public void load(StringProperties properties, IRelativePathResolver resolver) throws EolModelLoadingException {
		...
		if (properties.hasProperty(PlainXmlModel.PROPERTY_EXPAND)) {
			this.expandEntityReferences = properties.getBooleanProperty(PlainXmlModel.PROPERTY_EXPAND, true);
		}
